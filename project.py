...
def newRestaurant():
    ...
    if request.method == 'POST':
        newRestaurant = Restaurant(
            name=request.form['name'], address=request.form['address'], city=request.form['city'], 
            state=request.form['state'], country=request.form['country'], zipcode=request.form['zipcode'],user_id=login_session['user_id'])
